			...
			<li>
				...
				<div id="subPages" class="collapse ">
					<ul class="nav">
							...
							<li><a href="typography.jsp" class="active"><i class="lnr lnr-text-format"></i> <span>Typography</span></a></li>
...
<!-- Mirrored from demo.thedevelovers.com/dashboard/klorofil-v2.0/typography.jsp by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 13 Feb 2021 12:19:41 GMT -->
</html>