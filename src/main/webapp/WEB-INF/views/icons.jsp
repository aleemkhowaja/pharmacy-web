...
<body>
			...
			<li>
				...
				<div id="subPages" class="collapse ">
					<ul class="nav">
							...
							<li><a href="icons.jsp" class="active"><i class="lnr lnr-linearicons"></i> <span>Icons</span></a></li>
	...
	<div class="panel panel-headline demo-icons">
		<div class="panel-heading">
			...
			<p class="subtitle">For complete list, please visit <a href="http://fontawesome.io/icons/icons.jsp" target="_blank">http://fontawesome.io/icons/</a></p>
		</div>
		<div class="panel-body">
			<ul class="list-unstyled row">
				<li class="col-md-2 col-sm-4 col-xs-6">
...
<!-- Mirrored from demo.thedevelovers.com/dashboard/klorofil-v2.0/icons.jsp by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 13 Feb 2021 12:19:41 GMT -->
</html>