...
<body class="page-header-fixed compact-menu page-horizontal-bar">
	...
	<%-- <jsp:include page="../common/menues.jsp" /> --%>
					...
					<!-- Start Search Fields -->
						...
						<form:form cssClass="m-t-md ajax-form-login validate-form" method="post" modelAttribute="dispatchpartydetails" id="dispatchpartySearch_form">
							<div class="row">
								<div class="col-25" style="float: left;width: 11%;margin-top: 6px;">
						        	<form:label  path="dispatchparty" cssStyle="padding: 7px 12px 12px 0;display: inline-block;"> Dispatch Party </form:label>
						      	</div>
						      	<div class="col-75" style="float: left; width: 21%;margin-top: 6px;">
						      		<form:select 	path="dispatchparty" cssClass="form-control" id="searcDispatchpartydetails_dispatchParty" 
		...
		<div id="main-wrapper" class="container">
			<div id="dispatchpartydetails-detail-grid-list" class="grid-container"></div>
			...
			<script type="text/javascript">
				$(document).ready(function(){
					...
					$("#dispatchpartydetails-detail-grid-list").jqGrid({
						url : "${returnAllDispatchPartyDetailsForGrid}",
				    ...
				    function editRow(id) {
		                if (id && id !== lastSelection) {
		                    var grid = $("#dispatchpartydetails-detail-grid-list");
				    ...
				    $('#search-dispatchpartydetails-button').on('click',function()
					{
						...
						jQuery("#dispatchpartydetails-detail-grid-list").jqGrid('setGridParam',{url:"dispatchpartydetails/findAll?dispatchParty="+dispatchParty}).trigger("reloadGrid");
				    });
				  });
				</script>
		<!-- Row -->
