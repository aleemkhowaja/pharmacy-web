	...
	<ul class="nav">
			...
			<li>
				...
				<div id="subPages" class="collapse in">
					<ul class="nav">
													<li><a href="page-profile.jsp" class="active">Profile</a></li>
...
<!-- Mirrored from demo.thedevelovers.com/dashboard/klorofil-v2.0/page-profile.jsp by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 13 Feb 2021 12:19:40 GMT -->
</html>