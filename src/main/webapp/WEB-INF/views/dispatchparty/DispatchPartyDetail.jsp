...
<div class="page-title">
	<div class="container">
		<div class="adv_ser_row" >
			...
			<!-- Start Search Fields -->
			<div class="col-md-8">
            	<form:form servletRelativeAction="${saveDispatchParty}" cssClass="m-t-md ajax-form-login validate-form" method="post" modelAttribute="dispatchparty" id="dispatchparty_form">
	                
	                <div class="form-group">
	                	<form:label  path="dispatchParty" > Dispatch Party * </form:label>
						<form:input path="dispatchParty" cssClass="form-control validate-required" id="dispatchparty" placeholder="Dispatch Party"  maxlength="255" />
	               	</div>
	               	
	               	<div class="form-group">
	                	<form:label  path="dispatchPartyOwner" > Dispatch Party Owner  </form:label>
						<form:input path="dispatchPartyOwner" cssClass="form-control validate-required" id="dispatchparty_owner" placeholder="Dispatcher Party Owner" maxlength="255"  />
	               	</div>
	               	
                    <button id="dispatchparty-save-btn" type="submit" class="btn" onclick="return dispatchparty_crud(event);">Save</button>
