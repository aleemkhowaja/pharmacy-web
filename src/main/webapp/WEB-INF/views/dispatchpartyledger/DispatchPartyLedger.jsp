...
<div class="page-title">
	<div class="container">
		<div class="adv_ser_row" >
			...
			<!-- Start Search Fields -->
			<div class="col-md-8">
            	<form:form  servletRelativeAction="${saveDispatchParty}" cssClass="m-t-md ajax-form-login validate-form" method="post" 
	               	...
	               	<div class="row" style="margin-bottom: 5px">
						...
						<div class="col-25" style="float: left;width: 15%;margin-top: 15px;">
				      	...
				      	<div class="col-75" style="float: left; width: 25%;margin-top: 6px;">
							<form:select path="requestDispatchPartyDetailsDTO.dispatchparty" cssClass="form-control" 
										 id="dispatchpartyledger_dispatchParty" onchange="dispatchPartyLedger_loadDispatchPartyDetails();">
...
<%-- 						
					...
					<table border="1" class="custom-table"  style="text-align: center; width: 100%" id="dispatchpartyledger_dispatchPartyDetailsTbl">
						<thead>
			            	<tr> 
			               		<th>Date</th>
			           			<th>Quality</th>
					...
					<div class="row">
						<div class="form-group">
							...
							<form:input path="recievedAccount"
								...
								id="dispatchpartyledger_accountNo"
								placeholder="Account No" maxlength="11" />
						</div>
					</div>
					<div class="row">
						<div class="form-group">
                     ...
                     <form:hidden path="requestDispatchPartyDetailsDTO.dispatchPartyDetailsId" id="dispatchpartydetails_dispatchpartydetailsId" />
                     <form:hidden path="dispatchPartyLedgerId" id="dispatchpartyledger_dispatchPartyLedgerId" />
                     <form:hidden path="requestDispatchPartyDetailsDTO.paidAmount" id="dispatchpartyledger_paidAmount" />
                     <form:hidden path="requestDispatchPartyDetailsDTO.amount" id="dispatchpartyledger_amount" />
                     
                     <div class="row">
						<div class="col-25" style="float: left;width: 15%;margin-top: 15px;">
				        	<button id="dispatchparty-save-btn" type="submit" class="btn" onclick="return dispatchPartyLedger_crud(event);">Save</button>
				      	</div>
					</div>
