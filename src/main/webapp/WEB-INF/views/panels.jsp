...
<body>
	...
	<ul class="nav">
					<li><a href="index-2.jsp" class=""><i class="lnr lnr-home"></i> <span>Dashboard</span></a></li>
							...
							<li><a href="panels.jsp" class="active"><i class="lnr lnr-cog"></i> <span>Panels</span></a></li>
...
<!-- Mirrored from demo.thedevelovers.com/dashboard/klorofil-v2.0/panels.jsp by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 13 Feb 2021 12:19:36 GMT -->
</html>